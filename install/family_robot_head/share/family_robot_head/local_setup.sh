...
: ${AMENT_CURRENT_PREFIX:="/opt/2026_product/family_robot_ws/install/family_robot_head"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/family_robot_head/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/family_robot_head/environment/path.sh"
