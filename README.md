...
🛠 常见问题
共享内存打开失败：先运行摄像头脚本
编译报错：检查 OpenCV /nlohmann_json 依赖
无权限写入记忆：执行 sudo chown -R $USER:$USER /home/robot
节点无响应：重新 source install/setup.bash
📄 开源协议
Apache 2.0
可自由使用、修改、分发、商用，保留作者声明即可。
👨‍💻 作者
家庭守护机器人・智能生活开发者
GitHub：hechenglaohou
